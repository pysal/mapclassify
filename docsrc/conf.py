...
#
# The full version.
version = mapclassify.__version__ #should replace it with your PACKAGE_NAME
...
latex_documents = [
    (master_doc, 'mapclassify.tex', u'mapclassify Documentation',
...
man_pages = [
    (master_doc, 'mapclassify', u'mapclassify Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mapclassify', u'mapclassify Documentation',
     author, 'PySAL Developers', 'map classification schemes.',
     'Miscellaneous'),
]
