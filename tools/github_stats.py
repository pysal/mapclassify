...
def get_issues(project="pysal/mapclassify", state="closed", pulls=False):
...
def issues_closed_since(period=timedelta(days=365), project="pysal/mapclassify", pulls=False):
